				...
				<section class="content container-fluid">
					<div class="row">
						<div class="col-md-10">
							...
							<strong>Id, Name, Number are optional</strong><br>
				...
				<section class="content container-fluid">
					<div class="row">
						<div class="col-md-10">
							...
							<form class="email-manager-form" action="emailmanager/upload" encType="multipart/form-data" autocomplete="off">
								@csrf
								<input type="hidden" id="user_id" name="user_id" value="{{ Auth::id()}}">
								<div class="form-group">
									<label for="batch_name" class="control-label">Batch Name</label>
									<input id="batch_name" name="batch_name" placeholder="Type batch name" type="text" class="form-control" required>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										<label class="input-group-btn">
											<span class="btn btn-primary">
												Browse&hellip; <input type="file" id="batch_file" style="display: none;" accept=".xls, .xlsx">
											</span>
										</label>
