...
class EmailManagerServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('emailmanager.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'emailmanager'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/emailmanager';
        }, \Config::get('view.paths')), [$sourcePath]), 'emailmanager');
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'emailmanager');
        }
    }
